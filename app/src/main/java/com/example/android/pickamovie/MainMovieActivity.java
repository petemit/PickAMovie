...
public class MainMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager gridLayoutMgr =
                new GridLayoutManager(context, GRIDLAYOUTCOLUMNCOUNT);
        ...
        protected void onPostExecute(JSONObject jo) {
            ...
            try {
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    MovieData md = new MovieData(overview,
                            poster_path,
                            release_date,
                            API_id,
                            original_title,
                            title,
                            Float.parseFloat(popularity),
                            Integer.parseInt(vote_count)
                            , Float.parseFloat(vote_average));
            ...
            if (curs != null) {
                while (curs.moveToNext()) {
                    MovieData md = new MovieData(
                            ...
                            curs.getString(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_POSTER_PATH)),
                            curs.getString(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_RELEASE_DATE)),
                            curs.getString(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_API_ID)),
                            curs.getString(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_ORIGINAL_TITLE)),
                            curs.getString(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_TITLE)),
                            curs.getFloat(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_POPULARITY)),
                            curs.getInt(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_VOTE_COUNT)),
                            curs.getFloat(curs.
                                    getColumnIndex(MovieDBContract.
                                            FavoriteMovies.COLUMN_VOTE_AVERAGE))
                    );
